...
import com.spring.boot.tutorial.SpringBootStarterAnnotation;
...
@SupportedAnnotationTypes(
        value = {"com.spring.boot.tutorial.SpringBootStarterAnnotation",
...
public class DevSpecProcessor extends AbstractProcessor {
    private static final String PACKAGE_START = "com.spring.boot.tutorial";
    @Override
