package com.spring.boot.tutorial.swagger;

import com.spring.boot.tutorial.util.IpAddressUtils;
import com.fasterxml.jackson.databind.introspect.BeanPropertyDefinition;
import com.spring.boot.tutorial.serialize.CustomizePropertyNamingStrategy;
...
public class SwaggerConfiguration {
     ...
     * @see CustomizePropertyNamingStrategy
     */
    @Primary
    @Bean
