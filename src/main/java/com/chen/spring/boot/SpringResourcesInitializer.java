...
public class SpringResourcesInitializer {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "com.chen.spring.boot", name = "pro", havingValue = "true")
    @PropertySource(value = "file:/usr/local/tools/config.properties", encoding="UTF-8")
    class ProductConfig {
    }

    @Configuration
    @ConditionalOnProperty(prefix = "com.chen.spring.boot", name = "pro", havingValue = "false", matchIfMissing = true)
